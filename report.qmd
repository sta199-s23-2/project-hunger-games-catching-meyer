...
null_dist_dist <- distance_filter |>
  ...
  calculate(stat = "diff in means", 
            order = c("short_distance", "long_distance"))
...
[DIFFICULTY TO SCORE VISUALIZATION]{.underline}
```{r}
...
[DISTANCE FROM MOSCOW TO SCORE VISUALIZATION]{.underline}
```{r}
...
[ALTITUDE TO SCORE VISUALIZATION]{.underline}
```{r}
