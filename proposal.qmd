...
-   We are in the process of adding more observations to the dataset, and there will be around 300 once the process is complete.

## Research question

-   How did Alexandra Trusova's jumping passes evolve over time, and how do different factors affect her successful execution of difficult technical content?
...
-   Alexandra Trusova is a notable Russian figure skater. She has spent 5 seasons competing internationally for Russia at various ISU-sanctioned competitions including the Grand Prix circuit, European championships, World championships, and even the Olympics. She has pushed the technical boundaries of the sport, and her development over the years is interesting to track. In her novice years, she struggled to land clean triple jumps. By her junior years, she was attempting quadruple jumps. By her senior years, she was attempting multiple quadruple jumps in each program, often in combination.
    ...
    Individual skaters may have preferences for competition location, such as those close to home. They may also be better at jumps attempted in the first half of a competition as compared to the second half. Their success rate at a particular jumping pass may change over the seasons. It's also possible that as a skater introduces a new jumping pass into their program, their success rate for other jumps will be affected. We hypothesize that there will be strong correlations between different variables (specifically jump number and level) and the successful outcome of a jumping pass.

-   There are both categorical and quantitative variables in this dataset. The variables jump_bv, goe, and point_value are quantitative, and the remaining variables, which describe the competition and the basic jump info are categorical, and the variables describing the point value of the jump (jump_bv, goe, point_value are quantitative.
...
-   The dataset titled supreme_court was created primarily by professor Harold J. Spaeth of Michigan State University Law. Individuals who assisted Dr. Spaeth in the initial creation of the dataset and/or the upkeep of the data since include Professor Lee Epstein, Professor Ted Ruger, Professor Jeffrey Segal, Professor Andrew D. Martin, and associate professor Sara Benesh. Dr. Spaeth produced the original dataset in the 1980s with funding from the National Science Foundation, but has been updating it since that date to reflect the outcomes of new Supreme Court cases. He collects data from official Supreme Court reports. The dataset is extensive and covers a wide variety of facts about each case, ranging from more generally known/easily researched facts (votes, date of decision, supreme court party leaning, etc.) to more obscure or generally unknown facts (type of laws considered in each case, originating court of each case, etc.). Because all of the data points were collected from publicly available reports and each individual potentially identified by the data is a public official, there are no ethical concerns about the dataset, particularly regarding privacy.
...
-   This is an important question to examine, particularly in political science work, because examining the factors of past Supreme court cases can shed light on which specific aspects of the Supreme court tend to lead to partisan results. Since the Supreme court is not intended to be a partisan body (rather it is intended to curb partisan bodies based off of interpretations of the constitution), knowing which aspects of a Supreme court case affect the hypothetical \"neutral\" nature of the court might be important in determining future policy designed to keep the Supreme court relatively \"unbiased.\" The factors we will be looking at as it relates to each partisan decision (which is a categorical variable coded as \"decision.direction\") are as follows: whether or not this decision overruled a previous Supreme Court decision (categorical), whether or not this decision deemed a government action unconstitutional (categorical), year in which the decision is made (categorical), type of issue the case considers (categorical), head Supreme Court judge at the time (categorical), type of petitioner (categorical), and \# of majority and minority votes (quantitative). We hypothesize that the type of issue and the time period will be the two most salient factors regarding partisan outcome. 
